...
function initializeHomeSearch() {
    ...
    const suggestionsDropdown = document.getElementById('home-search-suggestions');
    ...
    // Remove previous event listeners if reinitializing
    if (searchInput.hasAttribute('data-home-search-initialized')) {
        return; // Already initialized
    }
    searchInput.setAttribute('data-home-search-initialized', 'true');
...
window.initializeHomeSearch = initializeHomeSearch;
